            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="tab-content" style="background: #fff">
                    <div class="tab-pane fade in active p-15" id="car-info-tab">
                        <form id="request_drive" name="request_drive" class="reservation-form" method="post" onsubmit="return validateRequestTestDriveForm();" action="<?=base_url();?>ar/car-requests/request-test-drive/send-request">
                            <h4 class="text-gray mt-0 pt-5" style="text-align: right"> طلب اختبار القيادة</h4>
                            <hr>
                            <div class="row">
                                <div class="reservation-first-step">
                                    <div class="form-group col-md-12">
                                        <label style="text-align:right;display:block">الاسم بالكامل</label>
                                        ...
                                        <label id="full_name_error" style="display: none; text-align:right;"></label>
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <label id="mobile_error" style="color: red; display: none; text-align:right;"></label>
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <label id="email_error" style="color: red; display: none; text-align:right;"></label>
                                    </div>
                                    <div class="col-sm-12">
    ...
    <script type="text/javascript">
        function validateRequestTestDriveForm(){
            ...
            if(fullName == null || fullName == ""){
                ...
                document.getElementById('full_name_error').innerHTML = 'هذه الخانة مطلوبة.';
            } else if (fullName.length < 4) {
                document.getElementById("email_error").style.display = "block";
                document.getElementById('email_error').innerHTML = 'يجب أن يكون الاسم 4 أحرف على الأقل.';
            } else if (mobile == null || mobile == "") {
                document.getElementById("full_name_error").style.display = "none";

                document.getElementById("mobile_error").style.display = "block";
                document.getElementById('mobile_error').innerHTML = 'هذه الخانة مطلوبة.';
            } else if (mobile.length != 11) {
                document.getElementById("full_name_error").style.display = "none";
                document.getElementById("email_error").style.display = "none";
                
                document.getElementById("mobile_error").style.display = "block";
                document.getElementById('mobile_error').innerHTML = 'يجب أن يكون رقم الموبايل 11 حرف.';
            } else if (email == null || email == "") {
                document.getElementById("full_name_error").style.display = "none";
                document.getElementById("mobile_error").style.display = "none";

                document.getElementById("email_error").style.display = "block";
                document.getElementById('email_error').innerHTML = 'هذه الخانة مطلوبة.';
            } else {
                document.getElementById("full_name_error").style.display = "none";
                document.getElementById("mobile_error").style.display = "none";
                document.getElementById("email_error").style.display = "none";
                ...
                $("#request_drive").before('<div id="form-result" class="alert alert-success" role="alert" style="display: none;text-align:right;"></div>');
