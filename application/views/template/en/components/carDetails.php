...
<section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="<?= $imagesBaseURL.$result->mainPic; ?>">
      <div class="container pt-90 pb-50">
        <!-- Section Content -->
        <div class="section-content pt-100">
          <div class="row"> 
            <div class="col-md-12">
              <h3 style="color:#fff;"class="title"><?=$result->carNameEn; ?></h3>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="product">
                      ...
                      <div class="thumb">
                        <div class="flexslider-wrapper">
                          <div class="flexslider">
                            <ul class="slides">
                              <li><a href="<?= $imagesBaseURL.$result->externalImage1; ?>" title="external"><img src="<?= $imagesBaseURL.$result->externalImage1; ?>" alt=""></a></li>
                              <li><a href="<?= $imagesBaseURL.$result->externalImage2; ?>" title="external"><img src="<?= $imagesBaseURL.$result->externalImage2; ?>" alt=""></a></li>
                              <li><a href="<?= $imagesBaseURL.$result->externalImage3; ?>" title="external"><img src="<?= $imagesBaseURL.$result->externalImage3; ?>" alt=""></a></li>
                              <li><a href="<?= $imagesBaseURL.$result->internalImage1; ?>" title="internal"><img src="<?= $imagesBaseURL.$result->internalImage1; ?>" alt=""></a></li>
                              <li><a href="<?= $imagesBaseURL.$result->internalImage2; ?>" title="internal"><img src="<?= $imagesBaseURL.$result->internalImage2; ?>" alt=""></a></li>
                              <li><a href="<?= $imagesBaseURL.$result->internalImage3; ?>" title="internal"><img src="<?= $imagesBaseURL.$result->internalImage3; ?>" alt=""></a></li>
                            </ul>
                          </div>
                        </div>
              ...
              <div class="col-md-7 car-detail-custom">
                <div class="product-summary">
                  <h2 class="product-title"><?=$result->carNameEn; ?></h2>
                  ...
                  <div class="tags"><strong>Transmission: </strong><?=$result->transmission; ?></div>
                  <?php
                  if (strpos(strtolower($result->carNameEn), "faw x40") !== false) {
                  ?>
                  <br/><a class="btn btn-dark btn-theme-colored ajaxload-popup" style="float: left;" href="<?=base_url();?>car-requests/request-test-drive/<?=$result->carId;?>/<?=$result->carNameEn;?>/<?=$result->carNameAr;?>">Request Test Drive</a>
                  <?php } ?>
...
<!--<script type="text/javascript" src="<?= asset_url();?>rater/jquery.rateyo.js"></script>-->$_ENV