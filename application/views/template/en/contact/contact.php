...
<section class="divider">
      <div class="container pt-0">
        <div class="row mb-60 bg-deep">
          ...
          <div class="col-sm-12 col-md-4">
            <div class="contact-info text-center  pt-60 pb-60 border-left border-right">
              <i class="fa fa-map-marker font-36 mb-10 text-theme-colored"></i>
              <h4>Address</h4>
              <h6 class="text-gray">Al Shaheed Axis, Takseem Al Marwa7a, Kattameya, Nasr City, Cairo.</h6>
            </div>
          </div>
          <div class="col-sm-12 col-md-4">
            <div class="contact-info text-center  pt-60 pb-60">
        ...
        <div class="row pt-10">
          ...
          <div class="col-md-7">
            ...
            <!-- Contact Form -->
            <form id="contact_form" name="contact_form" class="" action="<?=base_url();?>sendMail" method="post">
